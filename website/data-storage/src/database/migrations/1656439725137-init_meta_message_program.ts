...
export class initMetaMessageProgram1656439725137 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "message" ("genesis" character varying NOT NULL, "blockHash" character varying, "timestamp" TIMESTAMP, "id" character varying NOT NULL, "destination" character varying NOT NULL, "source" character varying NOT NULL, "payload" character varying, "error" character varying, "replyTo" character varying, "replyError" character varying, "processedWithPanic" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "meta" ("id" SERIAL NOT NULL, "program" character varying NOT NULL, "owner" character varying NOT NULL, "meta" character varying, "metaFile" character varying, CONSTRAINT "PK_c4c17a6c2bd7651338b60fc590b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "program" ("genesis" character varying NOT NULL, "blockHash" character varying, "timestamp" TIMESTAMP, "id" character varying NOT NULL, "owner" character varying NOT NULL, "name" character varying NOT NULL, "title" character varying, "initStatus" "public"."program_initstatus_enum" NOT NULL DEFAULT 'in progress', "metaId" integer, CONSTRAINT "REL_78c75d89b4fd889ef67d5e3030" UNIQUE ("metaId"), CONSTRAINT "PK_3bade5945afbafefdd26a3a29fb" PRIMARY KEY ("id"))`,
    );
