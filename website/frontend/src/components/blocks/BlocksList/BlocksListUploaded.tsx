...
import { getUserProgramsAction, resetGasAction, resetProgramPayloadTypeAction, sendMessageResetAction, uploadMetaResetAction } from 'store/actions/actions';
    ...
    <div className="block-list">
      ...
      </div>
      {
        ...
        (<div className="programs-list">
          { programs.map((program) => <UserProgram program={program} handleOpenForm={handleOpenForm}/>)}
        </div>
        )
        ||
        (
