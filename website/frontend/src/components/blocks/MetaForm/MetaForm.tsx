...
const MetaForm = ({ programHash, programName, socketService, handleClose }: Props) => {
                ...
                <div className="meta-form--wrapper">
                    <div className="meta-form--col">
                        ...
                        </div>
                        {
                            ...
                            &&
                            <div className="meta-form--info">
                                <label className="meta-form__field" htmlFor="meta">Upload file: </label>
                                <Field 
                                    id="meta" 
                                    name="meta" 
                                    className="is-hidden" 
                            ...
                            <>
                                <div className="meta-form--info">
                                    <label htmlFor="incomingType" className="meta-form__field">Incoming type:</label>
                                    <div className="meta-form__field-wrapper">
                                        ...
                                        />
                                        {errors.incomingType && touched.incomingType ? <div className="meta-form__error">{errors.incomingType}</div> : null}
                                    </div>
                                </div>
                                <div className="meta-form--info">
                                    <label htmlFor="expectedType" className="meta-form__field">Expected type:</label>
                                    <div className="meta-form__field-wrapper">
                                        <Field 
                                            id="expectedType" 
                                            name="expectedType" 
                                        ...
                                        />
                                        {errors.expectedType && touched.expectedType ? <div className="meta-form__error">{errors.expectedType}</div> : null}
                                    </div>
                                </div>
                            </>
                        }
                        <button
                            className='meta-form__button'
                            type="submit">
                                Upload program
                        </button>
                    </div>
