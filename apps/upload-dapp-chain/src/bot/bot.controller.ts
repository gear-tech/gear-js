...
export class BotController {
  ...
  @Command("updateWorkflowWasmUrls")
  public async updateWorkflowWasmUrls(ctx: Context): Promise<void> {
    const res = await this.botService.updateWorkflowWasmUrls(ctx.from.id);
