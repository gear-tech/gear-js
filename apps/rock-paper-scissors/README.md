...
React application of [Rock Paper Scissors](https://github.com/gear-dapps/rock-paper-scissors) based on [Rust smart-contract](https://github.com/gear-dapps/rock-paper-scissors).
