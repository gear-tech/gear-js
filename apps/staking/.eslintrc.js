module.exports = {
  ...
  rules: {
    ...
    'react/jsx-props-no-spreading': ['error', { exceptions: ['Input', 'FileInput', 'Textarea', 'Select', 'FormField'] }], // disable for form elements, cuz @mantine/form input props needs to be desctructured
  },
};
