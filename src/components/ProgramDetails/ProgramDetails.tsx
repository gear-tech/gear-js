    ...
    return(
        <div className='program-details'>
            ...
            <div className='program-details__download'>
                <progress className='program-details__progress' max="100" value="65"></progress>
                <div className="program-details__progress-value"></div>
                <div className="program-details__progress-bg">
                    <div className="program-details__progress-bar"></div>
                </div>
            </div>
            <div className='program-details__wrapper'>
                <div className='program-details__wrapper-column1'>
                    <div className='program-details__info'>   
                        ...
                        <span className='program-details__filename program-details__value'>awesomeprogramnam...
                            <span>.tbd</span>
                            <button type='button'><img alt='cancel'src={cancel}/></button>
                        </span>
                    </div>
                    <div className='program-details__info'>   
                ...
                <div className='program-details__buttons'>
                    <button type='button' className='program-details__upload'>Upload program</button>
                    <button type='button' className='program-details__cancel'>Cancel upload</button>
                </div>
            </div>
        </div>
    )
