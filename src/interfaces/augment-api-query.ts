...
// import type { IntermediateMessage } from 'sample-polkadotjs-typegen/interfaces/default';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    gear: {
      dequeueLimit: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> &
        QueryableStorageEntry<ApiType, []>;
      // messageQueue: AugmentedQuery<ApiType, () => Observable<Option<Vec<IntermediateMessage>>>, []> & QueryableStorageEntry<ApiType, []>;
      messagesProcessed: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    transactionPayment: {
      nextFeeMultiplier: AugmentedQuery<
        ApiType,
