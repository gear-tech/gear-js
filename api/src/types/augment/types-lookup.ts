...
declare module '@polkadot/types/lookup' {
  ...
  interface GearRuntimeProxyType extends Enum {
  ...
  interface PalletGearEvent extends Enum {
  ...
  type GearCoreIdsMessageId = U8aFixed;

  /** @name GearCoreIdsProgramId (51) */
  type GearCoreIdsProgramId = U8aFixed;

  /** @name GearCommonEventMessageEntry (52) */
  interface GearCommonEventMessageEntry extends Enum {
  ...
  interface GearCoreMessageUserUserMessage extends Struct {
    readonly id: GearCoreIdsMessageId;
  ...
  interface GearCoreErrorsSimpleSuccessReplyReason extends Enum {
  ...
  interface GearCoreErrorsSimpleErrorReplyReason extends Enum {
  ...
  interface GearCoreErrorsSimpleSimpleExecutionError extends Enum {
  ...
  interface GearCoreErrorsSimpleSimpleProgramCreationError extends Enum {
  ...
  interface GearCommonEventReasonUserMessageReadRuntimeReason extends Enum {
  ...
  interface GearCommonEventUserMessageReadRuntimeReason extends Enum {
  ...
  interface GearCommonEventUserMessageReadSystemReason extends Enum {
    readonly isOutOfRent: boolean;
    readonly type: 'OutOfRent';
  }

  /** @name GearCommonEventDispatchStatus (69) */
  interface GearCommonEventDispatchStatus extends Enum {
    readonly isSuccess: boolean;
  ...
  interface GearCommonGasProviderNodeGasNodeId extends Enum {
  ...
  type GearCoreIdsReservationId = U8aFixed;

  /** @name GearCommonEventReasonMessageWaitedRuntimeReason (77) */
  interface GearCommonEventReasonMessageWaitedRuntimeReason extends Enum {
    readonly isRuntime: boolean;
  ...
  interface GearCommonEventMessageWaitedRuntimeReason extends Enum {
  ...
  interface GearCommonEventMessageWaitedSystemReason extends Enum {
  ...
  interface GearCommonEventReasonMessageWokenRuntimeReason extends Enum {
    readonly isRuntime: boolean;
  ...
  interface GearCommonEventMessageWokenRuntimeReason extends Enum {
    readonly isWakeCalled: boolean;
    readonly type: 'WakeCalled';
  }

  /** @name GearCommonEventMessageWokenSystemReason (82) */
  interface GearCommonEventMessageWokenSystemReason extends Enum {
  ...
  type GearCoreIdsCodeId = U8aFixed;

  /** @name GearCommonEventCodeChangeKind (84) */
  interface GearCommonEventCodeChangeKind extends Enum {
  ...
  interface GearCommonEventProgramChangeKind extends Enum {
    readonly isActive: boolean;
    readonly asActive: {
      readonly expiration: u32;
    } & Struct;
  ...
  interface PalletGearVoucherEvent extends Enum {
  ...
  interface GearRuntimeSessionKeys extends Struct {
    readonly babe: SpConsensusBabeAppPublic;
    readonly grandpa: SpConsensusGrandpaAppPublic;
  }

  /** @name PalletGearCall (188) */
  interface PalletGearCall extends Enum {
  ...
  interface PalletGearVoucherCall extends Enum {
  ...
  interface GearRuntimeOriginCaller extends Enum {
    readonly isSystem: boolean;
  ...
  interface GearCoreCodeInstrumentedCode extends Struct {
    readonly code: Bytes;
  ...
  interface GearCoreMessageDispatchKind extends Enum {
    readonly isInit: boolean;
    readonly isHandle: boolean;
    readonly isReply: boolean;
    readonly isSignal: boolean;
  ...
  interface GearCommonCodeMetadata extends Struct {
    readonly author: H256;
    readonly blockNumber: Compact<u32>;
  }

  /** @name GearCommonProgram (222) */
  interface GearCommonProgram extends Enum {
    readonly isActive: boolean;
  ...
  interface GearCommonActiveProgram extends Struct {
    readonly allocations: BTreeSet<u32>;
  ...
  interface GearCoreReservationGasReservationSlot extends Struct {
    readonly amount: u64;
    readonly start: u32;
    readonly finish: u32;
  }
  ...
  interface GearCommonProgramState extends Enum {
  ...
  interface GearCommonPausedProgramStorageResumeSession extends Struct {
  ...
  interface PalletGearProgramError extends Enum {
  ...
  interface GearCommonStorageComplicatedDequeueLinkedNode extends Struct {
  ...
  interface GearCoreMessageStoredStoredDispatch extends Struct {
  ...
  interface GearCoreMessageStoredStoredMessage extends Struct {
    readonly id: GearCoreIdsMessageId;
    readonly source: GearCoreIdsProgramId;
    readonly destination: GearCoreIdsProgramId;
    readonly payload: Bytes;
  ...
  interface GearCoreMessageCommonMessageDetails extends Enum {
    readonly isReply: boolean;
  ...
  interface GearCoreMessageCommonSignalDetails extends Struct {
    readonly to: GearCoreIdsMessageId;
    readonly code: GearCoreErrorsSimpleSignalCode;
  }

  /** @name GearCoreErrorsSimpleSignalCode (242) */
  interface GearCoreErrorsSimpleSignalCode extends Enum {
    readonly isExecution: boolean;
    readonly asExecution: GearCoreErrorsSimpleSimpleExecutionError;
    readonly isRemovedFromWaitlist: boolean;
  ...
  interface GearCoreMessageContextContextStore extends Struct {
  ...
  interface GearCoreMessageUserUserStoredMessage extends Struct {
    readonly id: GearCoreIdsMessageId;
    readonly source: GearCoreIdsProgramId;
    readonly destination: GearCoreIdsProgramId;
    readonly payload: Bytes;
  ...
  interface GearCommonStoragePrimitivesInterval extends Struct {
    readonly start: u32;
    readonly finish: u32;
  }

  /** @name PalletGearMessengerError (258) */
  interface PalletGearMessengerError extends Enum {
  ...
  interface GearCommonSchedulerTaskScheduledTask extends Enum {
  ...
  interface PalletGearSchedulerError extends Enum {
  ...
  interface GearCommonGasProviderNodeGasNode extends Enum {
  ...
  interface GearCommonGasMultiplier extends Enum {
  ...
  type GearCommonGasProviderNodeNodeLock = Vec<u64>;

  /** @name GearCommonGasProviderNodeChildrenRefs (266) */
  interface GearCommonGasProviderNodeChildrenRefs extends Struct {
    readonly specRefs: u32;
    readonly unspecRefs: u32;
  }

  /** @name PalletGearGasError (267) */
  interface PalletGearGasError extends Enum {
  ...
  interface PalletGearSchedule extends Struct {
  ...
  interface PalletGearScheduleLimits extends Struct {
  ...
  interface PalletGearScheduleInstructionWeights extends Struct {
    readonly version: u32;
  ...
  interface PalletGearScheduleHostFnWeights extends Struct {
  ...
  interface PalletGearError extends Enum {
  ...
  interface PalletGearVoucherError extends Enum {
  ...
  interface PalletGearBankBankAccount extends Struct {
    readonly gas: u128;
    readonly value: u128;
  }

  /** @name PalletGearBankError (277) */
  interface PalletGearBankError extends Enum {
    readonly isInsufficientBalance: boolean;
  ...
  type PalletGearPaymentCustomChargeTransactionPayment = PalletTransactionPaymentChargeTransactionPayment;

  /** @name GearRuntimeRuntime (293) */
  type GearRuntimeRuntime = Null;
}
