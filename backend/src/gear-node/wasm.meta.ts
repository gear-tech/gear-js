export async function getWasmMetadata(wasmBytes) {
  ...
  metadata.init_input = JSON.parse(
    readMeta(memory, module.instance.exports.meta_init_input),
  );
  metadata.init_output = JSON.parse(
    readMeta(memory, module.instance.exports.meta_init_output),
  );
  metadata.input = JSON.parse(
    readMeta(memory, module.instance.exports.meta_input),
  );
  metadata.output = JSON.parse(
    readMeta(memory, module.instance.exports.meta_output),
  );
