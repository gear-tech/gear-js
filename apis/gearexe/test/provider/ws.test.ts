...
import { WsGearexeProvider } from '../../src/provider/ws.js';
...
describe('WsGearexeProvider - Connection Management', () => {
  describe('Constructor & Auto-connect', () => {
    test('should not auto-connect when autoConnect is false', () => {
      const provider = new WsGearexeProvider(TEST_WS_URL, { autoConnect: false });
    ...
    test('should auto-connect when autoConnect is true (default)', async () => {
      const provider = new WsGearexeProvider(TEST_WS_URL);
    ...
    test('should use default URL and apply custom options', () => {
      const provider = new WsGearexeProvider(undefined, {
        autoConnect: false,
        reconnectAttempts: 5,
        reconnectDelay: 2000,
...
describe('WsGearexeProvider - State Management', () => {
  ...
  test('should expose correct state via getters', () => {
    const provider = new WsGearexeProvider(TEST_WS_URL_CUSTOM, { autoConnect: false });
...
describe('WsGearexeProvider - Request Handling', () => {
...
describe('WsGearexeProvider - Subscription Handling', () => {
...
describe('WsGearexeProvider - Event System', () => {
...
describe('WsGearexeProvider - Error Handling', () => {
...
describe('WsGearexeProvider - Edge Cases', () => {
