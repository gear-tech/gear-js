import type { GasLimit, ProgramCreateOptions, ProgramUploadOptions, Value } from '@gear-js/api';
...
export { Method, ProgramError, ProgramStatus, TransactionName, TransactionStatus };
