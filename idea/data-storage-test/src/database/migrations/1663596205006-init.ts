...
export class init1663596205006 implements MigrationInterface {
  name = 'init1663596205006';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TYPE "public"."code_status_enum" AS ENUM(\'Active\', \'Inactive\')');
    await queryRunner.query('CREATE TABLE "code" ("genesis" character varying NOT NULL, "blockHash" character varying, "timestamp" TIMESTAMP, "id" character varying NOT NULL, "name" character varying NOT NULL, "status" "public"."code_status_enum", "expiration" integer, "mata_id" integer, CONSTRAINT "REL_c7b6c24862b8cc4a0ff252dfda" UNIQUE ("mata_id"), CONSTRAINT "PK_367e70f79a9106b8e802e1a9825" PRIMARY KEY ("id"))');
    ...
    await queryRunner.query('CREATE TABLE "program" ("genesis" character varying NOT NULL, "blockHash" character varying, "timestamp" TIMESTAMP, "id" character varying NOT NULL, "owner" character varying NOT NULL, "name" character varying NOT NULL, "title" character varying, "type" "public"."program_type_enum" NOT NULL DEFAULT \'unknown\', "code_id" character varying, "meta_id" integer, CONSTRAINT "PK_3bade5945afbafefdd26a3a29fb" PRIMARY KEY ("id"))');
    ...
    await queryRunner.query('CREATE TABLE "message" ("genesis" character varying NOT NULL, "blockHash" character varying, "timestamp" TIMESTAMP, "id" character varying NOT NULL, "destination" character varying NOT NULL, "source" character varying NOT NULL, "payload" character varying, "value" character varying NOT NULL DEFAULT \'0\', "exitCode" integer, "replyToMessageId" character varying, "processedWithPanic" boolean, "entry" "public"."message_entry_enum", "expiration" integer, "type" "public"."message_type_enum", "readReason" "public"."message_readreason_enum", "program_id" character varying, CONSTRAINT "PK_ba01f0a3e0123651915008bc578" PRIMARY KEY ("id"))');
