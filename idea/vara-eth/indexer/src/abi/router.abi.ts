...
function getEventDecoder<TEventName extends ContractEventName<typeof IROUTER_ABI>>(eventName: TEventName) {
  return (log: Log): DecodeEventLogReturnType<typeof IROUTER_ABI, TEventName> =>
    decodeEventLog({
      abi: IROUTER_ABI,
...
function getFnDecoder<const TFnName extends ContractFunctionName<typeof IROUTER_ABI>>(_fnName: TFnName) {
  return (transaction: Transaction): DecodeFunctionDataReturnType<typeof IROUTER_ABI, TFnName> =>
    decodeFunctionData({
      abi: IROUTER_ABI,
