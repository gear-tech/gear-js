...
module.exports = class Init1766579849556 {
  ...
  async up(queryRunner) {
    await queryRunner.query(
      `CREATE TABLE "batch" ("id" character varying NOT NULL, "block_hash" bytea NOT NULL, "block_timestamp" bigint NOT NULL, "previous_committed_batch_hash" bytea NOT NULL, "expiry" integer NOT NULL, "committed_at_block" bigint NOT NULL, "committed_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_57da3b830b57bec1fd329dcaf43" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE TYPE "public"."code_status_enum" AS ENUM('0', '1', '2')`);
    await queryRunner.query(
      `CREATE TABLE "code" ("id" character varying NOT NULL, "status" "public"."code_status_enum" NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_367e70f79a9106b8e802e1a9825" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."hash_registry_type_enum" AS ENUM('0', '1', '2', '3', '4', '5', '6', '7')`,
    );
    await queryRunner.query(
      `CREATE TABLE "hash_registry" ("id" character varying NOT NULL, "type" "public"."hash_registry_type_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_666886d02f27e4af99b8ddf7f6a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "program" ("id" character varying NOT NULL, "code_id" character varying NOT NULL, "created_at_block" bigint NOT NULL, "created_at_tx_hash" bytea NOT NULL, "abi_interface_address" bytea, "created_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_3bade5945afbafefdd26a3a29fb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "state_transition" ("id" character varying NOT NULL, "hash" bytea NOT NULL, "timestamp" TIMESTAMP NOT NULL, "program_id" character varying NOT NULL, "exited" boolean NOT NULL DEFAULT false, "inheritor" bytea, "value_to_receive" bigint, "batch_hash" character varying, CONSTRAINT "PK_08a49842a67b84f47fab2746ea2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "message_sent" ("id" character varying NOT NULL, "source_program_id" character varying NOT NULL, "destination" bytea NOT NULL, "payload" bytea NOT NULL, "value" bigint NOT NULL, "is_call" boolean NOT NULL DEFAULT false, "state_transition_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_8b1b9e0af3eac42a29879166fbb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "ethereum_tx" ("id" character varying NOT NULL, "contract_address" bytea NOT NULL, "selector" character varying(10) NOT NULL, "data" bytea NOT NULL, "sender" bytea NOT NULL, "block_number" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_5b147d8b5498e37a58abc7d3341" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
