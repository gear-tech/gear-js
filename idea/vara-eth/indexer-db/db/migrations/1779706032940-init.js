...
module.exports = class Init1779706032940 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "code" ("id" character varying NOT NULL, "status" "public"."code_status_enum" NOT NULL DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_367e70f79a9106b8e802e1a9825" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "hash_registry" ("id" character varying NOT NULL, "type" "public"."hash_registry_type_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_666886d02f27e4af99b8ddf7f6a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "injected_transaction" ("id" character varying NOT NULL, "reply_id" bytea NOT NULL, "destination" bytea NOT NULL, "sender_address" bytea NOT NULL, "reference_block" bytea NOT NULL, "salt" bytea NOT NULL, "signature" bytea NOT NULL, "value" bigint NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "payload" bytea NOT NULL, CONSTRAINT "PK_aacdeffed2b9709a45078ce660c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "program" ("id" character varying NOT NULL, "code_id" character varying NOT NULL, "created_at_tx_hash" bytea NOT NULL, "abi_interface_address" bytea, "created_at_block" bigint NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_3bade5945afbafefdd26a3a29fb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "state_transition" ("id" character varying NOT NULL, "hash" bytea NOT NULL, "program_id" character varying NOT NULL, "value_to_receive" bigint, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "exited" boolean NOT NULL DEFAULT false, "inheritor" bytea, "batch_hash" character varying, CONSTRAINT "PK_08a49842a67b84f47fab2746ea2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ethereum_tx" ("id" character varying NOT NULL, "contract_address" bytea NOT NULL, "sender" bytea NOT NULL, "selector" bytea NOT NULL, "block_number" bigint NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "data" bytea NOT NULL, CONSTRAINT "PK_5b147d8b5498e37a58abc7d3341" PRIMARY KEY ("id"))`);
