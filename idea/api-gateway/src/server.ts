...
const METHODS_FOR_CACHE_WITH_EXPIRATIONS: Record<string, number> = {
  [INDEXER_METHODS.CODE_DATA]: 300,
  [INDEXER_METHODS.PROGRAM_DATA]: 300,
  [INDEXER_METHODS.MESSAGE_DATA]: 300,
  [INDEXER_METHODS.PROGRAM_ALL]: 10,
...
const METHODS_FOR_CACHE: string[] = Object.keys(METHODS_FOR_CACHE_WITH_EXPIRATIONS);
