...
export class RequestType1760434006491 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "faucet_request" ALTER COLUMN "type" TYPE "public"."faucet_request_type_enum" USING "type"::"text"::"public"."faucet_request_type_enum"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "faucet_request" ALTER COLUMN "type" TYPE "public"."faucet_request_type_enum_old" USING "type"::"text"::"public"."faucet_request_type_enum_old"`,
    );
