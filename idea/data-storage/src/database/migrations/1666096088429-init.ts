...
export class init1666096088429 implements MigrationInterface {
  name = 'init1666096088429';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TYPE "public"."code_status_enum" AS ENUM(\'Active\', \'Inactive\')');
    await queryRunner.query('CREATE TABLE "code" ("genesis" character varying NOT NULL, "blockHash" character varying, "timestamp" TIMESTAMP NOT NULL, "_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "id" character varying NOT NULL, "name" character varying NOT NULL, "status" "public"."code_status_enum" NOT NULL, "expiration" character varying, "meta_id" integer, CONSTRAINT "REL_8aa019d7912f73ed38fc813815" UNIQUE ("meta_id"), CONSTRAINT "PK_3faae0c7f4cfa80186e791ce7f1" PRIMARY KEY ("_id"))');
    ...
    await queryRunner.query('CREATE TABLE "block" ("_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "number" character varying NOT NULL, "hash" character varying, "timestamp" TIMESTAMP, CONSTRAINT "PK_51cafb3a347f80b2e155f1185a9" PRIMARY KEY ("_id"))');
