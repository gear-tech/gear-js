module.exports = class Data1721043886461 {
  ...
  async up(db) {
    ...
    await db.query(
      `CREATE TABLE "code" ("block_hash" character varying(66), "block_number" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "id" character varying NOT NULL, "uploaded_by" character varying, "name" character varying, "status" text NOT NULL, "expiration" character varying, "metahash" character varying, "meta_type" character varying, CONSTRAINT "PK_367e70f79a9106b8e802e1a9825" PRIMARY KEY ("id"))`,
    );
    await db.query(
