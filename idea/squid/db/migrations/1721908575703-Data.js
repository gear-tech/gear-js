module.exports = class Data1721908575703 {
    ...
    async up(db) {
        await db.query(`CREATE TABLE "program" ("block_hash" character varying(66), "block_number" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "id" character varying NOT NULL, "owner" character varying, "name" character varying, "expiration" character varying, "status" text NOT NULL DEFAULT 'unknown', "code_id" character varying NOT NULL, "meta_type" character varying, "metahash" character varying, CONSTRAINT "PK_3bade5945afbafefdd26a3a29fb" PRIMARY KEY ("id"))`)
